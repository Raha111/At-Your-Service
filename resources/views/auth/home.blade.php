...
<body>
	<header>
		<div class="navbar">
			<nav>
				<img src="assets/images/my_logo2-removebg-preview.png" alt="logo" class="logo">
			<ul>
				...
				<li><a href="/login">CONTACT US</a>
				</li>
				<li class="ctn"><a href="/login">LOGIN</a></li>
			</ul>
			</nav>
		</div>
	</header>
	...
	<section id="base1">
		<div class="base">
			<div class="detel">
              ...
              <br>
              <br><br>
              <a href="/login" class="req">Request Service</a>
            </div>  
	...
	<!-- popular services section -->
	 <section id="popular">
        ...
        <div class="pbox" data-aos="slide-up" data-aos-duration="1000" data-aos-delay="100">
            <div class="p1" >
